...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        final EventPreMotion eventPreMotion = new EventPreMotion(rotationYaw, rotationPitch, onGround, posX, getEntityBoundingBox().minY, posZ, isSneaking(), isSprinting());
        eventPreMotion.call();

        if(eventPreMotion.isCancelled())
            return;

        boolean flag = eventPreMotion.isSprinting();
        ...
        boolean flag1 = eventPreMotion.isSneaking();
